...
struct FriendsPlayerWidgetEntryView: View {
...
struct FriendsPlayerWidget: Widget {
    let kind: String = "FriendsPlayerWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            FriendsPlayerWidgetEntryView(entry: entry)
