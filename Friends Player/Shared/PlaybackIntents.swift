...
//  Friends Player + FriendsPlayerWidget (shared)
//
...
struct PlayPauseIntent: AppIntent {
    ...
    static var description = IntentDescription("Toggle play and pause in Friends Player.")
...
struct OpenAlbumIntent: AppIntent {
    ...
    static var description = IntentDescription("Open a specific album in Friends Player.")
